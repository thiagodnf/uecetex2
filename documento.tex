...
% Coloque 'sim' se o trabalho for de um curso vinculado a Universidade
% Aberta do Brasil - UAB. Isso adiciona o brasao da UAB ao lado do brasao
% da UECE e a linha "Universidade Aberta do Brasil" na capa, alem da frase
% de parceria na folha de rosto (ver Figuras 5 e 11 do Guia de
% Normalizacao da UECE)

\ehuab{nao}

% Cidade do polo/unidade do interior onde o curso e ofertado (usada
% SOMENTE na capa). A folha de rosto e a folha de aprovacao continuam
% usando a cidade definida em \local (normalmente a sede da UECE em
% Fortaleza), pois e assim que o Guia trata os trabalhos de cursos a
% distancia/UAB. Deixe em branco se a cidade for a mesma de \local.
% Exemplo: \localdopolo{Limoeiro do Norte -- Ceará}
...
\begin{document}	
	...
	\bibliographystyle{lib/abntex2-alf.bst} % Ajustes ABNT NBR 10520:2023 	
