...
\begin{document}	
	...
	% Para inserir um pdf da folha de aprovação assinada, coloque-a em: 
	% "elementos-pre-textuais/folha-de-aprovacao", comente a linha acima e 
	% descomente a linha abaixo.
	% \imprimirfolhadeaprovacaopdf{elementos-pre-textuais/folha-de-aprovacao}
